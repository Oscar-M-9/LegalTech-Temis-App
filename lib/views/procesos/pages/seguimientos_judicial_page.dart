...
class SeguimientoJudicialInfiniteScrollPagination extends StatefulWidget {
  final ScrollController scrollController;
  final FetchDataFunction fetchDataFunction;
  final int exp;
  const SeguimientoJudicialInfiniteScrollPagination({
    Key? key,
  ...
  @override
  State<SeguimientoJudicialInfiniteScrollPagination> createState() =>
      _InfiniteScrollPaginationState();
}

class _InfiniteScrollPaginationState
    extends State<SeguimientoJudicialInfiniteScrollPagination> {
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildDataMovements(
                            "Fecha de Ingreso: ",
                            items[index]["fecha_ingreso"],
                          ),
                          _buildDataMovements(
                            "Fecha de Resolución: ",
                            items[index]["fecha_resolucion"],
                          ),
                          _buildDataMovements(
                            "Resolución: ",
