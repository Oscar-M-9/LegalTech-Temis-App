...
class SeguimientoSinoeInfiniteScrollPagination extends StatefulWidget {
  final ScrollController scrollController;
  final FetchDataFunction fetchDataFunction;
  final int exp;
  const SeguimientoSinoeInfiniteScrollPagination({
    Key? key,
  ...
  @override
  State<SeguimientoSinoeInfiniteScrollPagination> createState() =>
      _InfiniteScrollPaginationState();
}

class _InfiniteScrollPaginationState
    extends State<SeguimientoSinoeInfiniteScrollPagination> {
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 5),
                                    child: Text(
                                      items[index]['n_notificacion'].toString(),
                                      style: TextStyle(
                                        fontSize: 16,
                          ...
                          _buildDataMovements(
                            "N° Notificación: ",
                            items[index]["n_notificacion"],
                          ),
                          _buildDataMovements(
                            "N° Expediente: ",
                            items[index]["n_expediente"],
                          ),
                          _buildDataMovements(
                            "Sumilla: ",
                            items[index]["sumilla"],
                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              itemCount: items[index]["notify"].length,
                              itemBuilder: (context, index2) {
                                final doc =
                                    items[index]["notify"][index2]["documento"];
                                return doc.startsWith('../storage/')
                                    ? Column(
                                        children: [
                                          InkWell(
                                            onTap: () async {
