...
class SeguimientoIndecopiInfiniteScrollPagination extends StatefulWidget {
  final ScrollController scrollController;
  final FetchDataFunction fetchDataFunction;
  final int exp;
  const SeguimientoIndecopiInfiniteScrollPagination({
    Key? key,
  ...
  @override
  State<SeguimientoIndecopiInfiniteScrollPagination> createState() =>
      _InfiniteScrollPaginationState();
}

class _InfiniteScrollPaginationState
    extends State<SeguimientoIndecopiInfiniteScrollPagination> {
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildDataMovements(
                            "Acción realizada: ",
                            items[index]["accion_realizada"],
                          ),
                          _buildDataMovements(
                            "Anotaciones: ",
                            items[index]["anotaciones"],
                          ),
                          const SizedBox(
                            height: 10,
                          ),
